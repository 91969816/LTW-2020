                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/')}}"><img
                                    src="{{URL::to('public/frontend/images/pet-shop-logo.jpg')}}" class="img-responsive"
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                        ...
                                        <img alt="" src="{{URL::to('public/uploads/customer/'.$image)}}" height="40"
                                            width="40">
                                        <?php else:?>
                                        <img alt="" src="{{URL::to('public/uploads/customer/no-avatar.png')}}"
                                            height="40" width="40">
                                        <?php endif;?>
                                        <span class="username">
                                            <?php
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="col-sm-10">
                                    ...
                                    <img src="{{URL::to('imagesCat/meo-bengal.jpg')}}" class="girl img-responsive"
                                        alt="" />
                                    <p>Xuất hiện vào thế kỷ 19 ở Mỹ, mèo Bengal là kết quả lai chéo giữa mèo nhà Mỹ và
                                        mèo báo châu Á. Cái tên “Bengal” lấy họ từ mèo Felis Bengalensis và giống mèo
                                        này được phát triển giống những loài mèo hoang, mèo rừng như: Mèo gấm ocelots,
                                        báo hoa mai, báo gấm, mèo đốm margays.</p>
                            ...
                            <div class="item">
                                <div class="col-sm-10">
                                    ...
                                    <img src="{{URL::to('imagesCat/meo-ragdoll.jpg')}}" class="girl img-responsive"
                                        alt="" />
                                    <p>Mèo Ragdoll là tên một giống mèo với đôi mắt màu xanh dương và bộ lông hai màu
                                        tương phản đặc trưng. Nó là giống mèo to lớn, với cơ bắp rắn chắc và bộ lông mềm
                                        mại và hơi dài.Chúng cũng được biết đến là giống mèo hiền lành, dễ bảo và dễ
                                        thương. Mèo Ragdoll được một người gây giống Hoa Kỳ tên là Ann Baker phát triển,
                                        và cái tên Ragdoll xuất phát từ thói quen rũ người ra và thả lỏng cơ thể khi
                                        được bế lên của các cá thể mèo đời đầu tiên.</p>
                            ...
                            <div class="item">
                                <div class="col-sm-10">
                                    ...
                                    <img src="{{URL::to('imagesCat/meo-Sphynx.jpg')}}" class="girl img-responsive"
                                        alt="" />
                                    <p>Người ta gọi mèo Sphynx là mèo Ai Cập không phải vì Sphynx có nguồn gốc từ mảnh
                                        đất sinh ra các Pharaoh mà bởi vì ngoại hình của nó. Ban đầu người ta chỉ gọi là
                                        mèo không lông. Nhưng vì ngoại hình của chúng khá giống với bức tượng nhân sư ở
                                        Ai Cập nên cái tên mèo Ai Cập, mèo nhân sư ra đời.</p>
                            ...
                            <span style="font-size:15px;">
                                <span style="font-size:15px;">
                                    <strong>
                                        <span style="color:#FFFFFF;"><span
                                                style="text-align:center;text-indent:10px;">MUA HÀNG TRỰC
                                                TUYẾN</span></span>
                                    </strong>
                                ...
                                <strong>
                                    <span style="font-size:16px;">
                                        <span style="color:#FFFFFF;"><span
                                                style="text-align:center;text-indent:10px;">1900 633 501 -
                                                1</span></span>
                                    </span>
                                </strong>
                        ...
                        <p style="text-align:center;">
                            <span style="font-size:15px;">
                                <span style="font-size:15px;">
                                    <strong>
                                        <span style="color:#FFFFFF;"><span
                                                style="text-align:center;text-indent:10px;">CHĂM SÓC KHÁCH
                                                HÀNG</span></span>
                                    </strong>
                                </span><br style="font-size:15px;text-align:center;text-indent:10px;">
                                <strong>
                    ...
                    <div class="row">
                        <span style="color:#FFFFFF;">
                            <span style="text-align:center;text-indent:10px;">
                                <strong>
                                    <p>Địa chỉ 1824 Lê Văn Lương Xã Nhơn Đức , Huyện Nhà Bè , TP.Hồ Chí Minh
                                    <p>
                                </strong>
                            </span>
                        </span>
