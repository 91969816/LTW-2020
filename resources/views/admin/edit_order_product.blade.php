                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" value ="{{$edit_order_product['order_total']}}" name="order_total"
                                    class = "form-control" id="exampleInputEmail1">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Trạng thái</label>
                                    <input readonly type="text" value ="{{$edit_order_product['order_status']}}" name="order_status"
                                    class = "form-control" id="exampleInputEmail1">
